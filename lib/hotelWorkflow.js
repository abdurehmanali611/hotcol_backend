...
/** Store terminal: show pending + authorized lines; hide void/rejected only. */
export function itemRegistrationStoreTerminalWhere() {
  return {
    AND: [
      { NOT: { approvalStatus: ITEM_REG_VOID } },
      { NOT: { approvalStatus: { startsWith: "REJECTED" } } },
    ],
  };
}
